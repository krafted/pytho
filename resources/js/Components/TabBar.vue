<template>
    <header class="flex items-center justify-between px-4 border-b border-gray-100 dark:border-gray-800 md:py-3.5">
        <h3 class="hidden font-mono text-xs font-semibold tracking-wide text-gray-500 uppercase select-none dark:text-gray-700 md:block pl-safe-left">Editor</h3>
        ...
        <div class="flex items-center justify-between w-full -mb-px space-x-4 border-transparent md:hidden pl-safe-left pr-safe-right">
            <div class="flex items-center space-x-4">
                ...
                <button
                    ...
                    @click="state.activeTab = 'output', dirty = false"
                >
