        ...
        <div class="sm:px-4" :class="{'max-w-7xl mx-auto': !route().current('pen.show')}">
            <div class="flex items-center justify-between w-full grid-cols-3 py-1 md:grid pl-safe-left pr-safe-right">
                ...
                <div class="flex items-center justify-end -mr-2 space-x-2">
                    ...
                    <button
                        id="searchButton"
                        class="md:hidden flex items-center justify-center p-2.5 text-gray-600 dark:text-gray-400 border border-white bg-white dark:bg-gray-900 dark:border-gray-900 rounded-md group hover:w-auto hover:bg-gray-200 dark:hover:bg-gray-1000 focus:bg-gray-200 dark:focus:bg-gray-1000 focus:border-gray-300 dark:focus:border-gray-600 hover:border-gray-300 dark:hover:border-gray-600 hover:text-gray-900 dark:hover:text-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-200 dark:focus:ring-offset-gray-900 focus:ring-primary-500 focus:outline-none focus:w-auto"
