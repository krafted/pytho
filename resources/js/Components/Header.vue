<template>
    <header
        class="fixed inset-x-0 top-0 z-30 px-4 bg-white bg-opacity-75 border-b border-gray-100  sm:px-0 pt-safe-top dark:border-gray-800 backdrop-filter-blur dark:bg-opacity-75 dark:bg-gray-900"
    >
        <div
            class="sm:px-4"
            :class="{ 'max-w-7xl mx-auto': !route().current('pen.show') }"
        >
            <div
                class="flex items-center justify-between w-full py-1  md:gap-3 md:grid-cols-3 md:grid pl-safe-left pr-safe-right"
            >
                <div class="flex items-center -ml-3.5 space-x-2">
                    <x-logo class="text-lg px-3 h-10.5" />
                ...
                <div class="flex items-center justify-end -mr-2 space-x-2">
                    ...
                    <x-dropdown
                        v-if="
                            ...
                            page.props.value.jetstream.hasTeamFeatures
                        "
                        align="right"
                        width="48"
                    >
                            ...
                            >
                                ...
                                <x-dropdown-link
                                    :href="
                                        route(
                                            'teams.show',
                                            page.props.value.user.current_team
                                        )
                                    "
                                >
                                    Team Settings
                                ...
                                <template
                                    v-for="team in page.props.value.user
                                        .all_teams"
                                    :key="team.id"
                                >
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <template #content>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div
                                                class="flex flex-col justify-center leading-none text-left "
                                            >
                                                <div
                                        ...
                                        <svg
                                            class="w-3 h-3 ml-auto text-gray-500  justify-self-end"
                                            xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 20 20"
                                            fill="currentColor"
                                        >
                            ...
                            >
                                <span
                                    class="inline-flex items-center justify-between w-full space-x-2 "
                                >
                            ...
                            <div
                                class="px-3 py-2 -mb-1 space-x-1 text-xs text-center bg-gray-100 rounded-b  dark:bg-gray-800"
                            >
                                <a
                                    target="_blank"
                                    :href="route('terms.show')"
                                    class="text-gray-400  focus:ring focus:outline-none focus:ring-primary-500 hover:underline"
                                >
                                    Terms
                                </a>
                                ...
                                <a
                                    ...
                                    class="text-gray-400  focus:outline-none focus:ring focus:ring-primary-500 hover:underline"
                                >
                                    Privacy
                                </a>
                            </div>
...
import XDropdownLink from "@/Components/DropdownLink";
