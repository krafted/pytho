<template>
    <div
        class="flex-1 pr-safe-right"
        :class="{ 'pl-safe-left': preferences.layout === 'horizontal' }"
        :style="{
    ...
    >
        ...
        <transition leave-active-class="duration-200">
            <div
                v-show="show"
                class="absolute inset-0 z-10 flex flex-1 overflow-hidden pr-safe-right"
                :class="{ 'pl-safe-left': preferences.layout === 'horizontal' }"
            >
                <transition
                ...
                >
                    <div
                        v-show="show"
                        class="absolute inset-0 flex items-center justify-center flex-1 p-12 overflow-auto transition-opacity bg-gray-100 bg-opacity-25 dark:bg-gray-1000 dark:bg-opacity-25 backdrop-filter-blur focus:outline-none"
                    >
                        <transition
